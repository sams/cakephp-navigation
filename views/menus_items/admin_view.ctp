...
<div class="actions">
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete Menu Item', true), array('action' => 'delete', $menuItem['MenuItem']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Menu Items', true), array('action' => 'index', $menuId)); ?> </li>
		<li><?php echo $this->Html->link(__('New Menu Item', true), array('action' => 'add', $menuId)); ?> </li>
...
<div class="related">
	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<td class="actions">
				<?php echo $this->Html->link(__('View', true), array('controller' => 'menu_items', 'action' => 'view', $childMenuItem['id'])); ?>
				<?php echo $this->Html->link(__('Edit', true), array('controller' => 'menu_items', 'action' => 'edit', $childMenuItem['id'])); ?>
				<?php echo $this->Html->link(__('Delete', true), array('controller' => 'menu_items', 'action' => 'delete', $childMenuItem['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $childMenuItem['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
<?php endif; ?>
	...
	<div class="actions">
		<ul>
			<li><?php echo $this->Html->link(__('New Child Menu Item', true), array('controller' => 'menu_items', 'action' => 'add'));?> </li>
		</ul>
	</div>
</div>
